...
if __name__ == '__main__':
    ...
    print("Create Global Linear Model")
    if args.optimize:
    ...
    glm.create_feature_space(trainset)
    ...
    if args.bigdata:
        glm = GlobalLinearModel.load(args.file)
        print("Accuracy of test: %d / %d = %4f" %
              glm.evaluate(testset, average=args.average))
